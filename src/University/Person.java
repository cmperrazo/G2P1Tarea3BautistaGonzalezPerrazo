...
public class Person {
    ...
    public void showInformation(){
        ...
        do{
            ...
            lastName = nameCorrect(sc.nextLine());
            if(!data(getLastName())){
        ...
        // Validacion del numero de telefono
            do{
                ...
                if(searchUserJson(String.valueOf(phone))){
                    System.out.println("Este numero ya esta registrado, intentelo de nuevo");
                }
            }while(length(phone,9) || !String.valueOf(phone).startsWith("9") || searchUserJson(String.valueOf(phone)));      
        }   
   ...
   public void loginUniversity(){
    ...
    public String nameCorrect(String data){
        String letter = data.substring(0,1).toUpperCase();
        String letters = data.substring(1,data.length()).toLowerCase();
