...
public class Teacher extends Person{
    ...
    public void showInformation(){
        ...
        do{
            ...
            departament = nameCorrect(sc.nextLine());
            if(!data(departament)){
        ...
        do{
            System.out.print("\nTitulo de 3er Nivel: ");
            academicTitle = nameCorrect(sc.nextLine());
    ...
    public void createFileCsv(Teacher teacher) {
        try {
            ...
            if (isFileEmpty) {
                writer.writeRecord(new String[]{"UserName", "StudentId", "Identification", "Name", "LastName", "Phone", "Departament", "AcademicTitle"});
            }
